...
declare -a data_size=( 32 64 128 256 512 64 128 256 512 1024 )
declare -a memory_given=( 16 16 16 16 16 32 32 32 32 32 )
...
do
	...
	while [ $STATUS -gt 1 ] ; do
		sleep 5
		if (( $RANDOM % 2 == 1 )) || (( $CURRENT == memory_given_run*1024*1024 ));
		then
