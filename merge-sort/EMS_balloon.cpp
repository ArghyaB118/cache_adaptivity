...
int memProfSetup() {
  ...
  if (((dst = (unsigned long long*) mmap(0, sizeof(unsigned long long), PROT_READ | PROT_WRITE, MAP_SHARED , ipcfd, 0)) == (unsigned long long*)MAP_FAILED)){
...
int main(int argc, char *argv[]){
  ...
  //cgroup = new char[strlen(argv[6]) + 1](); strncpy(cgroup_name,argv[6],strlen(argv[6]));
